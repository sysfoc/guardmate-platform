...
export const sendGuardSignupAlert = async (
  adminEmail: string,
  guardName: string,
  guardEmail: string,
) => {
  await sendEmail({
    ...
    variables: {
      firstName: guardName,
      email: guardEmail,
      dashboardUrl: `${process.env.NEXT_PUBLIC_APP_URL}/admin/users`,
    },
  });
};

export const sendBossSignupAlert = async (
  adminEmail: string,
  bossName: string,
  companyName: string,
  bossEmail: string,
...
export const sendAccountApproved = async (
  userEmail: string,
  firstName: string,
  role: string,
) => {
...
export const sendAccountRejected = async (
  userEmail: string,
  firstName: string,
  role: string,
  reason: string,
...
export const sendAccountSuspended = async (
  userEmail: string,
  firstName: string,
  reason: string,
) => {
...
export const sendAccountBanned = async (
  userEmail: string,
  firstName: string,
  reason: string,
) => {
...
export const sendLicenseApproved = async (
  userEmail: string,
  firstName: string,
...
export const sendLicenseRejected = async (
  userEmail: string,
  firstName: string,
  licenseNumber: string,
  reason: string,
...
export const sendBidReceived = async (
  bossEmail: string,
  bossName: string,
  guardName: string,
  jobName: string,
  ...
  await sendEmail({
    ...
    variables: {
      ...
      jobName,
      amount: bidAmount,
      dashboardUrl: `${process.env.NEXT_PUBLIC_APP_URL}/dashboard/jobs/${jobId}/bids`,
    },
  });
};

export const sendBidAccepted = async (
  guardEmail: string,
  guardName: string,
  jobName: string,
  bossName: string,
...
export const sendBidRejected = async (
  guardEmail: string,
  guardName: string,
  jobName: string,
  bossName: string,
...
export const sendShiftCheckinAlert = async (
  bossEmail: string,
  bossName: string,
  guardName: string,
  location: string,
...
export const sendShiftCheckoutAlert = async (
  bossEmail: string,
  bossName: string,
  guardName: string,
  location: string,
...
export const sendShiftApproved = async (
  guardEmail: string,
  guardName: string,
  jobName: string,
  amount: number,
...
export const sendPaymentSent = async (
  guardEmail: string,
  guardName: string,
  amount: number,
  jobName: string,
...
export const sendDisputeRaised = async (
  againstEmail: string,
  againstName: string,
  raisedByName: string,
  raisedByRole: string,
  ...
  await sendEmail({
    ...
    variables: {
      ...
      description,
      disputeId,
      dashboardUrl: `${process.env.NEXT_PUBLIC_APP_URL}/dashboard/${raisedByRole === "BOSS" ? "mate" : "boss"}/jobs`,
    },
  });
};

export const sendDisputeRaisedAdmin = async (
  adminEmail: string,
  raisedByName: string,
  raisedByRole: string,
  againstName: string,
  ...
  await sendEmail({
    ...
    variables: {
      ...
      currency,
      disputeId,
      adminUrl: `${process.env.NEXT_PUBLIC_APP_URL}/admin/disputes/${disputeId}`,
    },
  });
};

export const sendDisputeResponseReceived = async (
  adminEmail: string,
...
export const sendDisputeResponseNotification = async (
...
export const sendDisputeResolvedAdmin = async (
  adminEmail: string,
  jobTitle: string,
  decision: string,
  resolvedBy: string,
...
export const sendShiftAutoApproved = async (
  bossEmail: string,
  bossName: string,
  guardEmail: string,
  guardName: string,
...
export const sendDisputeDeadlineWarning = async (
  adminEmail: string,
  jobTitle: string,
  hoursLeft: number,
  disputeId: string,
...
export const sendLicenseExpiry30Days = async (
  userEmail: string,
  firstName: string,
  licenseNumber: string,
  expiryDate: string,
...
export const sendShiftAssigned = async (
  ...
  const scheduleHtml = assignedSlots
    .map((s) => {
      ...
      const overnight = s.isOvernight
        ? ' <span style="color:#d97706;font-weight:600;">(+1 day)</span>'
        : "";
...
export const sendAdminOtp = async (email: string, code: string) => {
  try {
    ...
    await dbConnect();
    const EmailSettingsModel = (await import("@/models/EmailSettings.model"))
      .default;
