  ...
  return (
    ...
    >
      ...
      {isVisible && (
        ...
        >
          <div className="px-3 py-1.5 text-xs font-medium text-gray-900 bg-[var(--color-bg-elevated)] dark:text-[var(--color-text-primary)] rounded-md shadow-lg w-max max-w-xs text-center">
            {content}
            {/* Arrow */}
            <div className={cn(
