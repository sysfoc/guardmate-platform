...
export function DarkModeToggle() {
  ...
  return (
    <button
      onClick={toggleTheme}
      className="p-2.5 rounded-xl bg-[var(--color-bg-secondary)] border border-[var(--color-border-primary)] text-[var(--color-text-secondary)] hover:text-[var(--color-text-primary)] hover:bg-[var(--color-surface-hover)] transition-all flex items-center justify-center shadow-sm relative overflow-hidden group"
